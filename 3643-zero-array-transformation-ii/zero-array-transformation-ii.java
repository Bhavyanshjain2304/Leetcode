...
class Solution {
    ...
    public int minZeroArray(int[] nums, int[][] queries) {
        ...
        for (int index = 0; index < n; index++) {
            // Iterate through queries while the current index of nums cannot be reduced to
            // zero
            // sum: Keeps track of the total effect of all previous updates (from difference
            // array).
            // differenceArray[index]: The new update that is being applied at this index.
            // sum + differenceArray[index]: The effective value at index after applying all
            // updates so far.
